...
equipment:  client.o protocol.o utils.o
	$(CC) $(CFLAGS) -o equipment obj/client.o obj/protocol.o obj/utils.o

client.o:  src/client/client.c include/protocol.h include/utils.h
	@mkdir -p obj
